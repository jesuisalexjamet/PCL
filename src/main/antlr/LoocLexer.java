...
public class LoocLexer extends Lexer {
    ...
    public final void mIDF_CLASS() throws RecognitionException {
        try {
            int _type = IDF_CLASS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Looc.g:115:11: ( ( 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // Looc.g:115:13: ( 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
            // Looc.g:115:13: ( 'A' .. 'Z' )
            // Looc.g:115:14: 'A' .. 'Z'
            {
    ...
    public final void mIDF() throws RecognitionException {
        try {
            int _type = IDF;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Looc.g:116:5: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // Looc.g:116:7: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
    ...
    public final void mCSTE_CHAINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // Looc.g:118:13: ( '\"' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | ';' | ':' | '/' | ',' | '?' | '!' | '%' | '@' | '#' | '~' | '&' | '\\\\' | '-' | '_' | '|' | '(' | ')' | '{' | '}' | '[' | ']' | '=' | ' ' )+ '\"' )
            // Looc.g:118:15: '\"' ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | ';' | ':' | '/' | ',' | '?' | '!' | '%' | '@' | '#' | '~' | '&' | '\\\\' | '-' | '_' | '|' | '(' | ')' | '{' | '}' | '[' | ']' | '=' | ' ' )+ '\"'
            {
            match('\"');
            // Looc.g:118:19: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | ';' | ':' | '/' | ',' | '?' | '!' | '%' | '@' | '#' | '~' | '&' | '\\\\' | '-' | '_' | '|' | '(' | ')' | '{' | '}' | '[' | ']' | '=' | ' ' )+
            int cnt4=0;
            loop4:
            do {
                int alt4=2;
